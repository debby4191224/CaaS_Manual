...
<body>
    <div id="doc" class="markdown-body container-fluid comment-enabled" data-hard-breaks="true"><h1 id="商品型錄分類" data-id="商品型錄分類"><a class="anchor hidden-xs" href="#商品型錄分類" title="商品型錄分類"><span class="octicon octicon-link"></span></a><span>商品型錄分類</span></h1><p><span>此處可建立型錄分類，供建立商品型錄時選用。</span><br>
<img src="https://i.imgur.com/wtmP0fm.png" alt=""></p><h6 id="tags-CaaS" data-id="tags-CaaS"><a class="anchor hidden-xs" href="#tags-CaaS" title="tags-CaaS"><span class="octicon octicon-link"></span></a><span>tags: </span><code>CaaS</code></h6></div>
...
<li class=""><a href="#商品型錄分類" title="商品型錄分類">商品型錄分類</a></li>
</ul>
